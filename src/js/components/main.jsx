  ...
  return (
    <React.Fragment>
      <header className="page-header">
        <Logo />
        <Navigation location={`header`} isOpenMenu={isOpenMenu} setIsOpenMenu={setIsOpenMenu} setIsModal={setIsModal}/>
        {!isOpenMenu  && <SingIn setIsModal={setIsModal} isOpenMenu={isOpenMenu}/>}
      </header>
